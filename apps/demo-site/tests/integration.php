...
$formNodes = array_values(array_filter($form['document']['body'], fn (array $node) => $node['type'] === 'form'));
...
$assert($reply['document']['body'][0]['text'] === 'Dear Levi,', 'Dynamic packaged POST failed.');
